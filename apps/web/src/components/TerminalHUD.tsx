  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-md">
      <div
        ...
        } bg-[#04091a] border border-blue-500/40 rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.95)] flex flex-col font-mono overflow-hidden transition-all duration-200`}
      >
        {/* Terminal Title Bar */}
        <div className="px-4 py-3 bg-[#030716] border-b border-blue-950 flex items-center justify-between select-none">
        ...
        <div
          className="flex-1 p-4 overflow-y-auto space-y-4 text-xs sm:text-sm bg-[#02050f]/95 cursor-text"
        ...
        {/* Input Bar */}
        <div className="p-3 bg-[#030716] border-t border-blue-950 flex items-center space-x-2">
