  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-black/80 backdrop-blur-sm">
      <div
        ...
        } bg-[#0d1117] border border-zinc-700/80 rounded-xl shadow-2xl flex flex-col font-mono overflow-hidden transition-all duration-200`}
      >
        {/* Terminal Title Bar */}
        <div className="px-4 py-2.5 bg-[#161b22] border-b border-zinc-800 flex items-center justify-between select-none">
        ...
        <div
          className="flex-1 p-4 overflow-y-auto space-y-4 text-xs sm:text-sm bg-[#0d1117] cursor-text"
            ...
            <div key={log.id} className="space-y-1">
              {log.command && (
                <div className="flex items-center space-x-2 text-zinc-400">
                  <span className="text-emerald-400 font-semibold">abhimanyu@dev:~$</span>
                  <span className="text-zinc-100 font-medium">{log.command}</span>
        ...
        {/* Input Bar */}
        <div className="p-3 bg-[#161b22] border-t border-zinc-800 flex items-center space-x-2">
          <span className="text-emerald-400 font-semibold text-xs sm:text-sm flex-shrink-0">
            abhimanyu@dev:~$
          </span>
          <input
            ref={inputRef}
            ...
            className="flex-1 bg-transparent text-zinc-100 focus:outline-none text-xs sm:text-sm font-mono placeholder:text-zinc-600"
            autoFocus
          />
        </div>
      </div>
