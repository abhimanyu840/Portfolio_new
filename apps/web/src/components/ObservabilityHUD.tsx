      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 pb-4 border-b border-slate-800">
          ...
          <div className="mt-4 md:mt-0 flex items-center gap-3">
            ...
            <div className="px-2.5 py-1 rounded-lg bg-indigo-500/10 border border-indigo-500/30 font-mono text-xs text-indigo-300 flex items-center gap-1.5">
          ...
          <div className="glass-panel p-5 rounded-lg border border-slate-800 lg:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-center my-3">
              <div className="p-3 rounded-lg bg-slate-900/90 border border-slate-800">
                ...
                <div className="font-mono text-xs font-bold text-indigo-300 mt-1">SNMP &amp; Syslog</div>
              ...
              <div className="p-3 rounded-lg bg-slate-900/90 border border-slate-800">
                ...
                <div className="font-mono text-xs font-bold text-purple-300 mt-1">InfluxDB / Prom</div>
            ...
            <div className="mt-5 pt-4 border-t border-slate-800">
              <div className="font-mono text-xs text-slate-400 mb-3 flex items-center justify-between">
                ...
                <span className="text-indigo-400">4 / 4 HEALTHY</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {fabricNodes.map((node) => (
                  <div key={node.name} className="p-2.5 rounded-lg bg-slate-900/60 border border-slate-800/80 flex items-center justify-between">
                    <div>
                    ...
                    <div className="text-right">
                      <div className="font-mono text-[11px] font-bold text-indigo-400">{node.status}</div>
          ...
          <div className="glass-panel p-5 rounded-lg border border-slate-800 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between border-b border-slate-800 pb-3 mb-4">
                ...
                <span className="font-mono text-xs text-purple-400 font-semibold">99.9% SLA</span>
              </div>
                  ...
                  <div className="h-8 flex items-end gap-1.5 bg-slate-900/80 p-1.5 rounded border border-slate-800">
                    {latencyHistory.map((val, idx) => (
                      <div
                        ...
                        className="flex-1 bg-gradient-to-t from-blue-600/60 to-purple-500 hover:from-blue-500 hover:to-purple-400 rounded-t transition-all"
                        title={`${val}ms`}
                      />
                    ))}
                  </div>
